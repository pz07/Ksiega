...
def _ofc(id, width, height, url, use_swfobject, base="/")
	url = CGI::escape(url)
	out = []
...
def open_flash_chart_object(id, width, height, url, use_swfobject=true, base='/')
	return _ofc(id, width, height, url, use_swfobject, base)
end
